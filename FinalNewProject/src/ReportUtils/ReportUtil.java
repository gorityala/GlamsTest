...
public class ReportUtil {
	...
	public static int ScriptNumber1=1;
	public static String resultFilename;
	public static String currentDir;
	public static String suiteName;
	public static String SuiteName1;
	public static int tcid;
	public static String ErrorReportFilename;
	public static String SuiteDetailedReport;
	public static String Description;
	public static String suiteDetailedErrorReport;
	...
	//public static String RUN_DATE=TestBaseClass.now("dd-MMM-YYYY").toString();
	
	
	public static String getReportDir() {
		String reportDirectory= TestBaseClass.pro.getProperty("HTMLReportDirectory");
				//return System.getProperty("user.dir") + "/Reports";
		//return "C:\\FunctionalTestAutomationFramework\\FinalNewProject\\Reports";
	...
	//Suite1_TC2_Login.html
		private static String getTestFilePath() {
			...
			return getReportDir()+"\\DetailedTestCasesReport.html";
		
		}
		
		
		
		private static String getFailedCaseReport(String FailedLog){
			
			return getReportDir() +"\\" +FailedLog+ ".html";
		}
		
		
		public static void StartLoggingErrors(String Failedlog, String testStartTime, String env, String rel){
			ErrorReportFilename = getFailedCaseReport(Failedlog);
			FileWriter fstream = null;
			BufferedWriter out = null;
			try {
				// Create file

				fstream = new FileWriter(getFailedCaseReport(Failedlog));
				...
				out.write("<html>\n");
				out.write("<HEAD>\n");
				out.write(" <TITLE>Automation Test Failured Results</TITLE>\n");
				out.write("</HEAD>\n");

				out.write("<body>\n");
				out.write("<h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=5><b><u> Automation Test Failured Results</u></b></h4>\n");
				...
				String RUN_DATE = TestBaseClass.RUN_DATE("dd-MMM-YYYY");
				out.write("<tr>\n");
				out.write("<td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td>\n");
				out.write("<td width=200 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>" + RUN_DATE + "</b></td>\n");
				out.write("</tr>\n");
				...
				out.write("<td width=200 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>" + testStartTime + "</b></td>\n");
				out.write("</tr>\n");
				
				out.write("<tr>\n");
				// out.newLine();
				String END_TIME = TestBaseClass.now("dd-MMM-YYYY hh:mm:ss:SSS").toString();
				out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Run EndTime</b></td>\n");
				out.write("<td width=200 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>"+END_TIME+"</b></td>\n");
				out.write("</tr>\n");
				...
				out.write("<td width=200 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + ENVIRONMENT + "</b></td>\n");
				out.write("</tr>\n");
				out.write("<tr>\n");

				out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Release</b></td>\n");
				out.write("<td width=200 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + RELEASE + "</b></td>\n");
				out.write("</tr>\n");
		...
		public static void startTesting(String filename, String testStartTime, String env, String rel) {
			...
			try {
				...
				out.write("<body>\n");
				out.write("<h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=5><b><u> Automation Test Results</u></b></h4>\n");
		...
		public static void startSuite(String suiteName) {
			...
			try {
				...
				out.write("<h4> <FONT COLOR=660000 FACE= Arial  SIZE=5> <u>" + suiteName + " Report :</u></h4>\n");
		...
		public static void StartSuiteForErrorLogs(String SuiteName1){
			ReportUtil.SuiteName1 = SuiteName1;
			FileWriter fstream = null;
			BufferedWriter out = null;
			tcid = 1;
			try {

				fstream = new FileWriter(ErrorReportFilename, true);
				out = new BufferedWriter(fstream);

				out.write("<h4> <FONT COLOR=660000 FACE= Arial  SIZE=5> <u>" + SuiteName1 + " Report :</u></h4>\n");
				...
				out.write("<td width=30% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case Name</b></td>\n");
				out.write("<td width=10% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Status</b></td>\n");
				out.write("<td width=20% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run Start Time</b></td>\n");
				out.write("<td width=20% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Run End Time</b></td>\n");
		...
		public static void StartDetailedReport(String SuiteDetailedReport){
			ReportUtil.SuiteDetailedReport=SuiteDetailedReport;
			//Report=ReportUtil.getTestFilePath();
			FileWriter fstream = null;
			BufferedWriter out = null;
			
			try{
				fstream = new FileWriter(getTestFilePath());
				out = new BufferedWriter(fstream);
				out.write("<html>");
				out.write("<head>");
				out.write("<title>");
				...
				out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=5> Detailed Report :</h4>");
				
				out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
				
				out.write("<tr> ");
				out.write("<td align=center width=10%  align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>Test Script#</b></td>");
				...
				out.write("<td align=center width=15% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>Keyword</b></td>");
		...
		/*
		public static void addFailedTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status){
			newTest = true;
			FileWriter fstream = null;
			BufferedWriter out = null;
			...
			try {
				...
				if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
					...
					//f.createNewFile();
				fstream = new FileWriter(getTestFilePath(),true);
					out = new BufferedWriter(fstream);
					
					if (description != null) {
						for (int i = 0; i < description.size(); i++) {
							out.write("<tr> ");
							out.write("<td align=center width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>" + testCaseName + " </b></td>");
				...
				out.write("<tr>\n");
				out.write("<td width=10% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + ScriptNumber1 + "</b></td>\n");
				if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
					out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + testCaseName + "</b></td>\n");
				} else {
					out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=file://" + getTestFilePath() + ">" + testCaseName + "</a></b></td>\n");
				}
		...
		*/
		public static void addTestCase(String testCaseName,String DesCription, String testCaseStartTime, String testCaseEndTime, String status) {
			newTest = true;
			FileWriter fstream = null;
			BufferedWriter out = null;
			...
			try {
				...
				fstream = new FileWriter(getTestFilePath(),true);
					...
					out.write("<title>");
					//out.write(testCaseName + " Detailed Reports");
					out.write("Detailed Reports"+testCaseName);
					out.write("</title>");
					out.write("</head>");
					out.write("<body>");

					//out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=5> Detailed Report :"+testCaseName+" </h4>");
				...
				out.write("<td width=30% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + DesCription + "</b></td>\n");
				if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
					out.write("<td width=10% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + testCaseName + "</b></td>\n");
				} else {
					out.write("<td width=10% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=file://" + getTestFilePath() + ">" + testCaseName + "</a></b></td>\n");
				}
		...
		public static void addKeyword(String TestStepNo,String desc, String key, String stat, String path) {
			TestStepID.add(TestStepNo);
		...
		public static void addKeywordForFailedCases(String TestStepNo,String desc, String key, String stat, String path){
			TestStepID.add(TestStepNo);
			description.add(desc);
			keyword.add(key);
			teststatus.add(stat);
